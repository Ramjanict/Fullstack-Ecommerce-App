...
import DisplayFullScreenImage from "../componets/DisplayFullScreenImage";
import { MdDelete } from "react-icons/md";
import { toast } from "react-toastify";
import ApiList from "../backendUrl";

const AdminEditProduct = ({ productData, onClose, fetchAllProduct }) => {
  ...
  const handleOnSubmit = async (e) => {
    e.preventDefault();
    const fetchdata = await fetch(ApiList.updateProduct.url, {
