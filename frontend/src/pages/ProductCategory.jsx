...
const ProductCategory = () => {
  ...
  const fetchCategoryData = async () => {
    const fetchData = await fetch(ApiList.filter_product.url, {
      method: ApiList.filter_product.method,
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="hidden lg:grid grid-cols-[200px,1fr]">
        ...
        <div className="px-4">
          ...
          <div className="max-h-[calc(100vh-120px)] overflow-y-scroll scrollbar-none min-h-[calc(100vh-120px)] ">
